...
@Component({
  selector: 'app-show-questions-net',
  templateUrl: './show-questions-net.component.html',
  styleUrls: ['./show-questions-net.component.scss'],
})
export class ShowQuestionsNetComponent implements OnInit {
